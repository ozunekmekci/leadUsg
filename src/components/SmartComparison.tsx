      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <p className="text-text-muted text-sm mt-3 leading-relaxed">
            Markaların süslü pazarlama cümleleri yerine cihazların gerçek donanım yeteneklerini inceleyin. Prob frekans aralıkları, kanal sayıları, ekran teknolojileri ve yazılım modüllerini tarafsızca kıyaslayarak en doğru kararı verin.
          </p>
        </div>

        {/* Interactive Selector UI Container */}
        <div className="max-w-3xl mx-auto bg-surface-canvas border border-border-subtle p-6 sm:p-8 rounded-card shadow-card-rest">
          
          <div className="grid grid-cols-1 md:grid-cols-11 items-center gap-4 mb-8">
            {/* Dropdown 1 */}
            ...
            <div className="md:col-span-1 flex items-center justify-center pt-4 md:pt-0">
              <span className="h-10 w-10 rounded-full bg-brand-dark border border-brand-teal/30 text-white font-mono-tech text-xs flex items-center justify-center shadow-sm">
                VS
              </span>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 mb-8 pt-4 border-t border-border-subtle">
          ...
          <div className="text-center">
            ...
            >
              Cihaz Karşılaştırma Modülünü Başlatın
            </button>
          </div>
